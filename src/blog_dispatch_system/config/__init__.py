...
_external_files = [
    Path(sys.prefix, 'etc', 'blog_dispatch_system', 'settings.yml')
]


settings = Dynaconf(
    # Set env `BLOG_DISPATCH_SYSTEM_FOO='bar'`，use `settings.FOO` .
    envvar_prefix='BLOG_DISPATCH_SYSTEM',
    ...
    # env_switcher='BLOG_DISPATCH_SYSTEM_ENV',
